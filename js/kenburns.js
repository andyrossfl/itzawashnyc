...
function aurel_kenburns_resize() {
	/* Setup Thumbs */
	if (jQuery('.aurel_kenburns_wrapper.auto_height').length > 0) {
	...
	if (jQuery('.aurel_kenburns_wrapper.screen_height').length > 0) {
	...
	if (jQuery('.aurel_kenburns').find('#kenburns').length > 0) {
